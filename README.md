...
2.  Login, the API endpoints are all secured and need authentication to use in order to login click the "/api/Authenticate/login" dropdown and click the "try it out" button if done correctly you should see
